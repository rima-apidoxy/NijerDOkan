...
export default function ProductDetailPage({ params }) {
    ...
    const productUI = {
        ...
        // image: product.gallery?.[0]?.url?.startsWith("http") ? product.gallery[0].url : "/placeholder.png",
        ...
        colors: ["#f87171", "#60a5fa", "#34d399"], // static for now
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                    ...
                    <div className="flex items-center mt-6 flex-wrap gap-4">
                        <button
                            disabled={!productUI.inStock}
                            className={`px-6 py-3 rounded-md text-white font-semibold transition duration-300 ${productUI.inStock ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-400 cursor-not-allowed"
                                }`}
                        >
                            {productUI.inStock ? "Add to Cart" : "Out of Stock"}
                        </button>
