...
export default function CartTable() {
    ...
    const updateQuantity = async (productId, variantId, action) => {
        const accessToken = localStorage.getItem("accessToken");
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/v1/cart/item/${productId}`, {
                ...
                body: JSON.stringify({ variantId, quantity: 1, action }),
            });
            const data = await res.json();
        ...
        <div className="px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="md:col-span-2">
                            ...
                            <TableRow key={index}>
                                ...
                                <TableCell>
                                    <div className="flex items-center gap-2">
                                        <Button size="sm" variant="outline" onClick={() => updateQuantity(item.productId, item?.variantId, '-')}>-</Button>
                ...
                <div className="mt-6 flex gap-4">
                    ...
                    <Button variant="destructive" onClick={fetchCart}>Update Cart</Button>
                </div>
            </div>
